const {createRoom, getRoom, roomExists, addUserToRoom, getNumberOfPlayers, getMaxPlayers, isUserInRoom, getHost} = require("../services/rooms");
...
exports.checkGameP = (req, res) => {
    try {
        ...
        // ✅ AGGIUNGI QUESTE RIGHE: Confronta l'ID dell'utente con l'hostId
        const isAdmin = user.username === room.hostId;
            ...
            return res.status(200).json({
                ...
                isAdmin: isAdmin // ✅ AGGIUNGI QUESTO CAMPO
            });
        }
